...
- Cline SR workflow UI에서 workflow를 사용할 수 있으면 직접 호출합니다: `/brainstorm.md`, `/write-plan.md`, `/debug.md`, `/review.md`, `/finish-branch.md`, `/grill-me.md`, `/improve-codebase-architecture.md`.
